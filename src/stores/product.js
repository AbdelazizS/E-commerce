...
export const useProductStore = defineStore('products', () => {
  const products = ref([
    ...
    },
    {
      ...
      price: 10,
      image:
        'https://img.freepik.com/free-photo/strawberry-berry-levitating-white-background_485709-57.jpg?w=2000'
    },
    {
      name: 'Apples',
      price: 15,
  ...
  const totalPrice = computed(() => products.value.map((p) => p.price).reduce((a, b) => a + b, 0)) // computed = getter
