  ...
  <Container>
    ...
    <div class="py-8 mb-8">
      <div class="grid md:grid-cols-2 gap-6 md:gap-8 " v-if="favouriteItems?.length > 0">
        <div v-for="item in favouriteItems" :key="item.id"
          ...
          <div class="inline-flex items-center justify-between w-full">
            <div class="inline-flex items-center gap-2">
              ...
              <div class="">
                <h3 class="font-bold text-base text-foreground">Orders</h3>
                <p class="mt-1 text-sm text-muted-foreground">Hey! Do you remember about choosing your training
                  regime?
                </p>
              </div>
            </div>
            <p class="absolute top-3 end-3 text-xs text-muted-foreground ">2 hours ago</p>
          </div>
      ...
      <div v-else class="heroBg mb-8 md:mb-16 flex flex-col justify-center space-y-6 text-center items-center">
        <div>
          ...
          <h3 class="text-xl md:text-2xl font-semibold text-foreground">
            ...
            <span class="text-transparent font-bold bg-gradient-to-r from-[#D247BF] to-primary bg-clip-text">{{
